...
Calendar.prototype.nextMonth = function() {
    ...
    for (var h, l = dm = "M" == this.f ? 1 : 0 == o ? -5 : 2, v = (c = 0, 0); v < 6; v++) {
        d += '<div class="row">';
        for (var m = 0; m < 7; m++) {
            if ((h = c + dm - o) < 1) d += '<div class="cell disable"><span>' + (u - o + l++) + "</span></div>";
            else if (h > i) d += '<div class="cell disable"><span>' + l++ + "</span></div>";
            else {
                d += '<div class="cell' + (r == h && this.CurrentMonth == n && this.CurrentYear == a ? " active" : "") + '"><span onclick="toggleAptmt()"><span>' + h + "</span></span></div>", l = 1
            }
            c % 7 == 6 && h >= i && (v = 10), c++
        }
        d += "</div>"
